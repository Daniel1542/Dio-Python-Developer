...
with engine.connect() as conn:
    ...
    sql_insert_conta = text("insert into conta (id, tipo, agencia, num, saldo, id_cliente) values (1, 'poupanca', '0001', 11 , 5, 1)")
    conn.execute(sql_insert_conta)
  

    sql_insert_cliente_1 = text("insert into cliente (id, nome, cpf, endereco) values (1, 'Maria', '000222', 'rua')")
    conn.execute(sql_insert_cliente_1)


    sql_insert_cliente_2 = text("insert into cliente (id, nome, cpf, endereco) values (2, 'Maia', '00022', 'rua')")
