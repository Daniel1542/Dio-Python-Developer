...
class ContaCorrente(Conta):
    def __init__(self, numero, cliente, limite=1000, limite_saques=2):
...
class TransacaoFinanceira(Transacao):
...
def realizar_transacao_financeira(clientes, transacao_tipo, tipo):
    ...
    transacao = transacao_tipo(valor)
